      ...
      <section className="mx-auto flex max-w-3xl items-center justify-center px-6 py-16">
        <Card className="w-full max-w-md border-slate-200">
          <CardContent className="p-6">
            ...
            <p className="mb-6 text-slate-600">Start using the Legal AI dashboard.</p>
            ...
            <form className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-indigo-600 text-white hover:bg-indigo-700">Sign up</Button>
            </form>

            <p className="mt-4 text-center text-sm text-slate-600">
              Already have an account?{' '}
              <Link to="/signin" className="text-indigo-700 hover:underline">Sign in</Link>
            </p>
          </CardContent>
        </Card>
      </section>
